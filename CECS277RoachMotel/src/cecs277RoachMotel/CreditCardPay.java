...
public class CreditCardPay implements PaymentStrategy{
	 ...
	 */
	public CreditCardPay(String name, String cardNum, String cvv, String date) {
		this.name = name;
	...
	public String pay(double amount) {
		return "Paid: $" + amount + " using CreditCard." + "Name: " + this.name + "Card# " + this.cardNumber + "cvv :  " + this.cvv + "Expiration data: " + this.dateOfExpiry;
