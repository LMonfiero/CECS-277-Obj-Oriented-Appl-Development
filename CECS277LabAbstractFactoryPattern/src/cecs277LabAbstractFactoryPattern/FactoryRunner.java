...
public class FactoryRunner {
	...
	public static void main(String[] args) throws InvalidShapeException {
		...
		Point point1 = new Point (5 ,0), point2 = new Point (5,-10);
		Point pointC = new Point (5 ,-5);
		double rad = 5;
		
		Point [] twoPoints = {point1, point2};
		Point [] pointRad = {pointC, new Point (pointC.getX(), (pointC.getY() + rad)) };
		
		GeometricShape circle = factory.getGeometricShape(ShapeType.CIRCLE, twoPoints);
		GeometricShape circlePD = factoryPD.getGeometricShape(ShapeType.CIRCLE, pointRad);

		System.out.println(circle);
		System.out.println(circlePD);
